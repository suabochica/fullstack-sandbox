...
app.get('/api/questions', co.wrap(function* (request, response) {
...
app.get('/api/questions/:id', co.wrap(function* (request, response) {
...
app.get(['/', '/questions/:id'], co.wrap(function* (request, response) {
	...
	if (request.params.id) {
		...
		const questionResponse = yield getQuestion(question_id);
		const questionDetails = questionResponse.items[0];
